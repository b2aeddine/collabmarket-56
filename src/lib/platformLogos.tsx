...
/**
 * Fonction utilitaire partagée pour obtenir les logos de plateformes
...
export const getPlatformLogo = (platform: string) => {
  ...
  switch (platformName) {
    case 'instagram':
      return (
        <div className="w-10 h-10 rounded-lg bg-gradient-to-tr from-purple-500 via-pink-500 to-orange-500 flex items-center justify-center flex-shrink-0">
    ...
    case 'snapchat':
      return (
        <div className="w-10 h-10 rounded-xl bg-yellow-400 flex items-center justify-center relative overflow-hidden flex-shrink-0">
          <img 
            src={snapchatLogo} 
            alt="Snapchat" 

...
const InfluencerProfile = () => {
  ...
  const { reviewStats } = useReviews(id || '');
  ...
  const getPlatformLogo = (platform: string) => {
    ...
    switch (platformName) {
      case 'instagram':
        return (
          <div className="w-6 h-6 rounded-lg bg-gradient-to-tr from-purple-500 via-pink-500 to-orange-500 flex items-center justify-center">
      ...
      case 'snapchat':
        return (
          <div className="w-6 h-6 rounded-lg bg-yellow-400 flex items-center justify-center relative">
            <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center">
                          ...
                          <span className="font-semibold">
                            {influencer.rating > 0 
                              ? `${influencer.rating} (${influencer.reviewCount} avis)` 
                              : 'Pas encore d\'avis'
                            }
                          </span>
                        </div>
              ...
              <Card className="shadow-xl border-0 animate-fade-in">
                <CardContent className="p-4 sm:p-6">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                    {influencer.gallery.map((image, index) => (
                      <div
                        key={index}
                        className="aspect-square bg-gray-200 rounded-lg overflow-hidden hover:scale-105 transition-transform animate-fade-in"
                      >
                        <img
                          src={image}
